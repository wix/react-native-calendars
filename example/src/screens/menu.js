...
export default class MenuScreen extends Component {
  ...
  render() {
    return (
      <View>
        ...
        <TouchableOpacity style={styles.menu} onPress={this.oncalendarListWithStickyHeaderPress.bind(this)}>
        <Text style={styles.menuText}>Calendar List With Sticky Header</Text>
      </TouchableOpacity>
  ...
  oncalendarListWithStickyHeaderPress() {
    this.props.navigator.push({
      screen: 'calendarListWithStickyHeader',
      title: 'Calendars List With Sticky Header'
    });
  }
