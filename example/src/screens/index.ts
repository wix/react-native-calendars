...
import NewExpandableCalendarScreen from './newExpandableCalendarScreen';
...
export function registerScreens() {
  ...
  Navigation.registerComponent('NewExpandableCalendarScreen', () => NewExpandableCalendarScreen);
