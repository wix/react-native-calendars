...
import ThreeDayTimelineCalendarScreen from './threeDayTimelineCalendarScreen';
...
export function registerScreens() {
  ...
  Navigation.registerComponent('ThreeDayTimelineCalendarScreen', () => ThreeDayTimelineCalendarScreen);
