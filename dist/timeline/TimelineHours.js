...
const TimelineHours = (props) => {
    ...
    const handleBackgroundPress = useCallback(event => {
        ...
        onBackgroundLongPress === null || onBackgroundLongPress === void 0 ? void 0 : onBackgroundLongPress(timeString, lastLongPressEventTime.current);
    ...
    const handlePressOut = useCallback(() => {
        if (lastLongPressEventTime.current) {
            ...
            onBackgroundLongPressOut === null || onBackgroundLongPressOut === void 0 ? void 0 : onBackgroundLongPressOut(timeString, lastLongPressEventTime.current);
