...
const Timeline = (props) => {
    ...
    useEffect(() => {
        ...
        if (scrollToNow) {
            ...
            initialPosition = (_a = min(map(packedEvents[0], 'top'))) !== null && _a !== void 0 ? _a : 0;
        }
        else if (initialTime) {
        ...
        if (initialPosition) {
            setTimeout(() => {
                var _a;
                (_a = scrollView === null || scrollView === void 0 ? void 0 : scrollView.current) === null || _a === void 0 ? void 0 : _a.scrollTo({
    ...
    const _onEventPress = useCallback((dateIndex, eventIndex) => {
        ...
        if (eventTapped) {
            ...
            onEventPress === null || onEventPress === void 0 ? void 0 : onEventPress(event);
        }
