...
const Calendar = (props) => {
    ...
    const renderDay = (day, id) => {
        ...
        <Day {...dayProps} testID={`${testID}.day_${dateString}`} date={dateString} state={getState(day, currentMonth, props, isControlled)} marking={markedDates === null || markedDates === void 0 ? void 0 : markedDates[dateString]} onPress={_onDayPress} onLongPress={onLongPressDay}/>
      </View>);
    };
