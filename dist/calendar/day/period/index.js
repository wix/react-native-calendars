...
const PeriodDay = (props) => {
    ...
    return (<Component testID={testID} onPress={_onPress} onLongPress={_onLongPress} disabled={marking === null || marking === void 0 ? void 0 : marking.disableTouchEvent} accessible accessibilityRole={(marking === null || marking === void 0 ? void 0 : marking.disableTouchEvent) ? undefined : 'button'} accessibilityLabel={accessibilityLabel}>
      <View style={style.current.wrapper}>
        ...
        <View style={containerStyle}>
          ...
          <View style={style.current.dotContainer}>
            <Dot theme={theme} color={marking === null || marking === void 0 ? void 0 : marking.dotColor} marked={marking === null || marking === void 0 ? void 0 : marking.marked}/>
          </View>
        </View>
      </View>
    </Component>);
