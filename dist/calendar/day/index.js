...
const Day = React.memo((props) => {
    ...
    const getAccessibilityLabel = useMemo(() => {
        ...
        return `${_isToday ? today : ''} ${_date === null || _date === void 0 ? void 0 : _date.toString(formatAccessibilityLabel)} ${markingAccessibilityLabel}`;
    ...
    <Component {...props} accessibilityLabel={getAccessibilityLabel} {...dayComponentProps}>
      {formatNumbers(_date === null || _date === void 0 ? void 0 : _date.getDate())}
    </Component>);
}, areEqual);
export default Day;
Day.displayName = 'Day';
