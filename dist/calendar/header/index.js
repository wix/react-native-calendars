...
const CalendarHeader = forwardRef((props, ref) => {
    ...
    const addMonth = useCallback(() => {
        propsAddMonth === null || propsAddMonth === void 0 ? void 0 : propsAddMonth(1);
    }, [propsAddMonth]);
    ...
    const _renderHeader = () => {
        ...
        <Text allowFontScaling={false} style={style.current.monthText} testID={`${testID}.title`} {...webProps}>
          {formatNumbers(month === null || month === void 0 ? void 0 : month.toString(monthFormat))}
        </Text>
      </Fragment>);
    };
    ...
    const renderIndicator = () => {
        if (displayLoadingIndicator) {
            return (<ActivityIndicator color={theme === null || theme === void 0 ? void 0 : theme.indicatorColor} testID={`${testID}.loader`}/>);
        }
    };
