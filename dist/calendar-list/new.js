...
const CalendarList = (props) => {
    ...
    const style = useRef(styleConstructor(calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.theme));
    const list = useRef();
    ...
    const staticHeaderStyle = useMemo(() => {
        return [style.current.staticHeader, calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.headerStyle];
    }, [calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.headerStyle]);
    useEffect(() => {
    ...
    const scrollToMonth = useCallback((month) => {
        ...
        if (month) {
            ...
            if (index !== -1) {
                ...
                // @ts-ignore
                (_b = (_a = list.current) === null || _a === void 0 ? void 0 : _a.scrollToOffset) === null || _b === void 0 ? void 0 : _b.call(_a, index * constants.screenWidth, 0, shouldAnimate);
            }
        }
    }, [getMonthIndex]);
    ...
    const scrollToNextMonth = useCallback((method, month) => {
        var _a;
        if (calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.onPressArrowLeft) {
            (_a = calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.onPressArrowLeft) === null || _a === void 0 ? void 0 : _a.call(calendarProps, method, month);
        }
        else {
            updateMonth(1, month);
        }
    ...
    const scrollToPreviousMonth = useCallback((method, month) => {
        var _a;
        if (calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.onPressArrowRight) {
            (_a = calendarProps === null || calendarProps === void 0 ? void 0 : calendarProps.onPressArrowRight) === null || _a === void 0 ? void 0 : _a.call(calendarProps, method, month);
        }
        else {
            updateMonth(-1, month);
        }
