...
const WeekCalendar = (props) => {
    ...
    const { allowShadow = true } = props, calendarListProps = __rest(props, ["allowShadow"]);
    const _a = extractCalendarProps(calendarListProps), { style: propsStyle, onDayPress, firstDay = 0 } = _a, others = __rest(_a, ["style", "onDayPress", "firstDay"]);
    const { date, numberOfDays, updateSource, setDate, timelineLeftInset } = context;
    const visibleWeek = useRef(date);
    const style = useRef(styleConstructor(theme));
    const items = useRef(getDatesArray(current !== null && current !== void 0 ? current : date, firstDay, numberOfDays));
    ...
    useDidUpdate(() => {
        ...
        (_a = list === null || list === void 0 ? void 0 : list.current) === null || _a === void 0 ? void 0 : _a.scrollToIndex({ index: NUMBER_OF_PAGES, animated: false });
    }, [numberOfDays]);
    useDidUpdate(() => {
        var _a;
        if (updateSource !== UpdateSources.WEEK_SCROLL) {
            ...
            if (pageIndex !== currentIndex.current) {
                ...
                pageIndex <= 0 ? onEndReached() : (_a = list === null || list === void 0 ? void 0 : list.current) === null || _a === void 0 ? void 0 : _a.scrollToIndex({ index: adjustedIndexFrScroll, animated: false });
            }
        }
    }, [date, updateSource]);
    const containerWidth = useMemo(() => {
        return calendarWidth !== null && calendarWidth !== void 0 ? calendarWidth : constants.screenWidth;
    }, [calendarWidth]);
    ...
    const getCurrentWeekMarkings = useCallback((date, markings) => {
        ...
        return dates === null || dates === void 0 ? void 0 : dates.reduce((acc, date) => {
            ...
            return Object.assign(Object.assign({}, acc), (markings[dateString] && { [dateString]: markings[dateString] }));
        }, {});
    }, []);
    ...
    const onViewableItemsChanged = useCallback(({ viewableItems }) => {
        ...
        const newDate = (_a = viewableItems[0]) === null || _a === void 0 ? void 0 : _a.item;
...
function getDate(date, firstDay, weekIndex, numberOfDays) {
    ...
    const isSameWeek = offsetFromNow > 0 && offsetFromNow < (numberOfDays !== null && numberOfDays !== void 0 ? numberOfDays : 7);
