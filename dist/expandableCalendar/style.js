...
export default function styleConstructor(theme = {}) {
    ...
    return StyleSheet.create(Object.assign({ containerShadow: Object.assign({ backgroundColor: appStyle.calendarBackground }, Platform.select({
            ios: {
                shadowColor: '#858F96',
                shadowOpacity: 0.25,
                shadowRadius: 10,
            ...
            right: 20,
            bottom: 0
        }, todayButton: Object.assign({ height: constants.isTablet ? 40 : 28, paddingHorizontal: constants.isTablet ? 20 : 12, borderRadius: constants.isTablet ? 20 : 14, flexDirection: appStyle.todayButtonPosition === 'right' ? 'row-reverse' : 'row', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white' }, Platform.select({
            ios: {
                shadowColor: '#79838A',
                shadowOpacity: 0.3,
                shadowRadius: 14,
        ...
        } }, (((_b = (_a = theme === null || theme === void 0 ? void 0 : theme.stylesheet) === null || _a === void 0 ? void 0 : _a.expandable) === null || _b === void 0 ? void 0 : _b.main) || {})));
}
