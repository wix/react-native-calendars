...
const CalendarProvider = (props) => {
    ...
    const _setDate = useCallback((date, updateSource) => {
        ...
        onDateChanged === null || onDateChanged === void 0 ? void 0 : onDateChanged(date, updateSource);
        if (!sameMonth(new XDate(date), new XDate(prevDate.current))) {
            onMonthChange === null || onMonthChange === void 0 ? void 0 : onMonthChange(xdateToData(new XDate(date)), updateSource);
        }
    }, [onDateChanged, onMonthChange]);
    const _setDisabled = useCallback((disabled) => {
        var _a;
        if (showTodayButton) {
            (_a = todayButton.current) === null || _a === void 0 ? void 0 : _a.disable(disabled);
        }
    }, [showTodayButton]);
