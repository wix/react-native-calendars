...
const AgendaList = (props) => {
    ...
    const list = useRef();
    const _topSection = useRef((_a = sections[0]) === null || _a === void 0 ? void 0 : _a.title);
    ...
    const getNextSectionIndex = (date) => {
        ...
        for (let j = 1; j < sections.length; j++) {
            const prev = parseDate((_a = sections[j - 1]) === null || _a === void 0 ? void 0 : _a.title);
            const next = parseDate((_b = sections[j]) === null || _b === void 0 ? void 0 : _b.title);
    ...
    const scrollToSection = useCallback(debounce((d) => {
        ...
        if ((list === null || list === void 0 ? void 0 : list.current) && sectionIndex !== undefined) {
            ...
            _topSection.current = (_a = sections[sectionIndex]) === null || _a === void 0 ? void 0 : _a.title;
            list === null || list === void 0 ? void 0 : list.current.scrollToLocation({
                animated: true,
    ...
    const _onViewableItemsChanged = useCallback((info) => {
        if ((info === null || info === void 0 ? void 0 : info.viewableItems) && !sectionScroll.current) {
            const topSection = get(info === null || info === void 0 ? void 0 : info.viewableItems[0], 'section.title');
            if (topSection && topSection !== _topSection.current) {
                ...
                if (didScroll.current && !avoidDateUpdates) {
                    ...
                    setDate === null || setDate === void 0 ? void 0 : setDate(_topSection.current, UpdateSources.LIST_DRAG);
                }
            }
        }
    ...
    const _onMomentumScrollBegin = useCallback((event) => {
        setDisabled === null || setDisabled === void 0 ? void 0 : setDisabled(true);
        onMomentumScrollBegin === null || onMomentumScrollBegin === void 0 ? void 0 : onMomentumScrollBegin(event);
    }, [onMomentumScrollBegin, setDisabled]);
    const _onMomentumScrollEnd = useCallback((event) => {
        // when list momentum ends AND when scrollToSection scroll ends
        sectionScroll.current = false;
        setDisabled === null || setDisabled === void 0 ? void 0 : setDisabled(false);
