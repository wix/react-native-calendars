...
const UseTimelinePages = ({ date, listRef, numberOfDays }) => {
    ...
    const scrollToPage = (pageIndex) => {
        var _a;
        (_a = listRef.current) === null || _a === void 0 ? void 0 : _a.scrollToOffset(constants.isAndroidRTL ? ((PAGES_COUNT - 1 - pageIndex) * constants.screenWidth) : (pageIndex * constants.screenWidth), 0, false);
    };
