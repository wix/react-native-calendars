...
export default class AgendaView extends Component {
    static propTypes = {
        ...
        //callback that fires when the knob touch start
        onKnobTouchStart: PropTypes.func,
        //callback that fires when the knob touch end
        onKnobTouchEnd: PropTypes.func,
    ...
    onTouchStart() {
        ...
        if (this.knob) {
            if (this.props.onKnobTouchStart) this.props.onKnobTouchStart();
    ...
    onTouchEnd() {
        if (this.knob) {
            if (this.props.onKnobTouchEnd) this.props.onKnobTouchEnd();
