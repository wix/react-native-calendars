...
export default class AgendaView extends Component {
  ...
  componentWillReceiveProps(props) {
    if(props.selected !== this.state.selectedDay){
      this.currentMonth = this.state.selectedDay.clone();
    }
    if (props.items) {
        this.setState({
      ...
      <View onLayout={this.onLayout} style={[this.props.style, { flex: 1, overflow: 'hidden' }]}>
       ...
       }
        {
          ...
          <Animated.ScrollView
            ...
            scrollsToTop={false}
            onTouchStart={this.props.horizontal?null:this.onTouchStart}
            onTouchEnd={this.props.horizontal?null:this.onTouchEnd}
            onScrollBeginDrag={this.props.horizontal?null:this.onStartDrag}
