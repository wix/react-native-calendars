...
import styleConstructor from '../reservation-list/style';

class MonthReservationList extends Component {
  ...
  updateReservations(props) {
    ...
    if (
      ...
      this.list.scrollToIndex({
        index: reservations.scrollPosition,
        animated: true,
      });
    }
  ...
  onRowLayoutChange(ind, event) {
    if (ind === 0) {
      ...
      while (
        ...
        this.list.props.data[scrollIndex].day.getDate()
      ) {
        scrollIndex += 1;
      }
      this.scrollOver = false;
      this.list.scrollToIndex({index: scrollIndex, animated: false});
    }
...
export default MonthReservationList;
