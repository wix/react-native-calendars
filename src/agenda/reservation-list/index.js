...
class ReactComp extends Component {
  static displayName = 'Reservation-List';
  ...
  componentToBeMount() {
    let reservations = this.getReservations(this.props);
  ...
  updateReservations(props) {
    let reservations = this.getReservations(props);
  ...
  componentDidUpdate(prevProps, prevState) {
    let isSameRes = JSON.stringify(prevProps.reservations) === JSON.stringify(this.props.reservations);
    let isSameDate = dateutils.sameDate(prevProps.topDay, this.props.topDay);
    if (!isSameDate) {
      if (!isSameRes) {
        this.setState({ reservations: [] }, () => {
  ...
  render() {
    ...
    return (
      <View>
        <NavigationEvents
          onWillFocus={payload => {
            console.log("ReservationList", "will focus", payload);
            this.componentToBeMount()
          }}
        // onDidFocus={payload => {
        //   console.log("ReservationList", "did focus", payload);
        // }}
        // onWillBlur={payload => {
        //   console.log("ReservationList", "will blur", payload);
        // }}
        // onDidBlur={payload => {
        //   console.log("ReservationList", "did blur", payload);
        // }}
        />
        <FlatList
          ref={(c) => this.list = c}
