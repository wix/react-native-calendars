...
import {ActivityIndicator, View, StyleProp, ViewStyle, TextStyle, NativeSyntheticEvent, NativeScrollEvent, LayoutChangeEvent} from 'react-native';
...
class ReservationList extends Component<ReservationListProps, State> {
  ...
  private list: React.RefObject<FlashList<DayAgenda>> = React.createRef();
