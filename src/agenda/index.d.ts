...
export default class Agenda extends Component<AgendaProps, AgendaState> {
    ...
    static propTypes: {
        ...
        onScrollEndDrag: PropTypes.Requireable<(...args: any[]) => any>; /** callback that gets called when day changes while scrolling agenda list */
        onMomentumScrollBegin: PropTypes.Requireable<(...args: any[]) => any>; /** specify how agenda knob should look like */
