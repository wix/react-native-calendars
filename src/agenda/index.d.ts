...
export default class Agenda extends Component<AgendaProps, State> {
    ...
    static propTypes: {
        ...
        date: PropTypes.Requireable<any>; /** the list of items that have to be displayed in agenda. If you want to render item as empty date
        the value of date key kas to be an empty array []. If there exists no value for date key it is
        considered that the date in question is not yet loaded */
        ...
        indicatorStyle?: React.Validator<"default" | "black" | "white" | null | undefined> | undefined;
