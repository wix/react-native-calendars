...
import CalendarList, {CalendarListProps, CalendarListRefMethods} from '../calendar-list';
...
export default class Agenda extends Component<AgendaProps, State> {
  ...
  private calendar: React.RefObject<CalendarListRefMethods> = React.createRef();
