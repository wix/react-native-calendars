...
export type AgendaProps<T = any> = CalendarListProps &
 ...
 */
export default class Agenda<T = any> extends Component<AgendaProps<T>, State> {
  ...
  componentDidUpdate(prevProps: AgendaProps<T>, prevState: State) {
