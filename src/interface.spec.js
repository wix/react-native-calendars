...
describe("interface", () => {
	describe("parseDate()", () => {
		...
		it("should accept Date as argument", () => {
			...
			expect(getISODateString(testDate)).toEqual("2016-11-21T21:00:00Z");
			const time = 1479772800000;
			expect(getISODateString(getDate(time))).toEqual("2016-11-22T00:00:00Z");
		});
	...
	describe("dateToData()", () => {
		it("should convert date to data", () => {
			...
			expect(getISODateString(testDate)).toEqual("2016-11-22T00:00:00Z");
			const data = dateToData(testDate);
			expect(data).toEqual({
				year: 2016,
				month: 11,
				day: 22,
	...
	describe("toMarkingFormat()", () => {
		it("should convert date to yyyy-MM-dd format string", () => {
			const time = 1479772800000;
			const testDate = getDate(time);
			expect(toMarkingFormat(testDate)).toEqual(
