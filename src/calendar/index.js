...
class Calendar extends Component {
  ...
  renderDay(day, id) {
    ...
    if (this.props.showDates) {
      this.props.showDates.forEach(item => {
        showDates = [...showDates, parseDate(item)];
      });
    }
    const index = showDates.findIndex(item => dateutils.sameDate(day, item));
    let state = '';
