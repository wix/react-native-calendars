...
export interface AgendaProps<TItem> extends CalendarBaseProps {
  /**
   *  Display loading indicator. Default = false
   */
  displayLoadingIndicator?: boolean
   ...
   */
  agendaLoadingIndicator?: boolean
  ...
  /**
   *  Provide custom day rendering component for the main calendar.
   */
  calendarDayComponent?: React.Component<DayComponentProps> | React.SFC<DayComponentProps>
}
