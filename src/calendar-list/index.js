...
import { FlatList, Platform, Dimensions, View, TouchableOpacity, Text } from 'react-native';
// @ts-expect-error
    ...
    return (
      <View style={this.style.flatListContainer}>
        <FlatList
          ...
          initialScrollIndex={
            this.state.openDate ? this.getMonthIndex(this.state.openDate) : undefined
          }
