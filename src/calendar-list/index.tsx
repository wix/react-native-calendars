...
class CalendarList extends Component<Props, State> {
  ...
  scrollToDay(d: XDate, offset: number, animated: boolean) {
    ...
    this.list?.current?.scrollToOffset({offset: 0, animated});
  ...
  scrollToMonth = (m: XDate) => {
    ...
    this.list?.current?.scrollToOffset({offset: 0, animated: false});
    this.list?.current?.scrollToOffset({offset: scrollAmount, animated: false});
  };
