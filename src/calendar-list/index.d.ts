...
declare class CalendarList extends Component<Props, State> {
    ...
    static propTypes: {
        ...
        firstDay: PropTypes.Requireable<number>; /** When true, the calendar list scrolls to top when the status bar is tapped. Default = true */
        ...
        onDayPress: PropTypes.Requireable<(...args: any[]) => any>; /** Called once when the scroll position gets within onEndReachedThreshold */
