export const backgroundColor = "#404957"
...
export const todayColor = "#FFC800"
export const holidayColor = "#FF0132"
export const saturdayColor = "#0071C4"
export const agendaDayTextColor = "#d9e1e8"
export const agendaDayNumColor = "#d9e1e8"
export const agendaTodayColor = textLinkColor
export const agendaKnobColor = "#4ac4f7"
